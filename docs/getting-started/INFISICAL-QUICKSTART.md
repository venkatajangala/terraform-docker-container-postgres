...
# Existing configuration - passwords are auto-generated by Terraform
postgres_user         = "pgadmin"
postgres_password     = "<auto-generated-by-terraform>"
postgres_db           = "postgres"
replication_password  = "<auto-generated-by-terraform>"
...
- Infisical service (port 8020) — official `infisical/infisical:latest` image
- Infisical Redis (`infisical-redis`, internal port 6379 — required by Infisical)
...
export PGPASSWORD='<db_admin_password from above>'
...
| Infisical Redis | internal only (6379) | No external port |
...
# Check Redis (required by Infisical server)
